class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
         ...
         validates :nickname,:name_family,:name_first,:kana_name_family,:kana_name_first,:bath,:email,:encrypted_password, presence: true
         ...
         validates :encrypted_password, length: { minimum: 6 },format: { with: /[a-z\d]{6,}/i, message: '6文字以上の半角英数字で設定してください' } do
         end
